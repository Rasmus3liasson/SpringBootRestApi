...
DROP
DATABASE IF EXISTS location;
CREATE
DATABASE location CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;;
...
VALUES ('Resturant', '🍔', 'Where you can order food'),
       ('Sport', '⚽', 'Sport related'),
...
VALUES ('Joans', 1, 101, 'Oriental resturant located in the city', POINT(12.9714, 77.5946)),
